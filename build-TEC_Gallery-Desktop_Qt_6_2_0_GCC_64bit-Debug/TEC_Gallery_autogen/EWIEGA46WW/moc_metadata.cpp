...
#include <memory>
#include "../../../TEC_Gallery/metadata.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_metadata_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_metadata_t qt_meta_stringdata_metadata = {
    {
QT_MOC_LITERAL(0, 8) // "metadata"
...
const QMetaObject metadata::staticMetaObject = { {
    ...
    qt_meta_stringdata_metadata.offsetsAndSize,
    qt_meta_data_metadata,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_metadata_t
...
void *metadata::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_metadata.stringdata0))
